        ...
        <List  style={{marginTop:120}} >
            ...
            <Collapse in={openmaterial} timeout="auto" unmountOnExit>
                <List component="div" disablePadding>
                    ...
                    <ListItem selected={selectedIndex === 7}  onClick={(event) => handleListItemClick(event, 7)} component={Link} exact to="/leather"className={classes.nested}>
            ...
            <ListItemLink selected={selectedIndex === 10} onClick={handleColorClick}>
                <ListItemText><span className={classes.listitemhead}>Colors</span></ListItemText>
